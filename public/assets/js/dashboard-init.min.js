...
($(function () {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#students-records-chart"), {
            chart: {
                height: 380,
                width: "100%",
                stacked: !1,
            ...
            series: [
                ...
                {
                    name: "Seviços Solicitados",
                    type: "line",
                    data: serviceRequestsPerMonth,
                },
                /* {
                    name: "Total de Clientes",
                    type: "line",
                    data: [4, 3, 46, 77, 52, 93, 91, 91, 96, 97, 83, 86],
                }, */
            ],
            fill: {
