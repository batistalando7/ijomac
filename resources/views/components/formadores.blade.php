<div class="elementor-element elementor-element-9331882 e-con-full e-flex e-con e-parent" data-id="9331882"
    ...
    <div class="elementor-element elementor-element-3f2610e elementor-widget elementor-widget-edplus-title"
        data-id="3f2610e" data-element_type="widget" data-e-type="widget" data-widget_type="edplus-title.default">
    ...
    <div class="elementor-element elementor-element-349b845 elementor-widget elementor-widget-edplus-instructors"
        data-id="349b845" data-element_type="widget" data-e-type="widget" data-widget_type="edplus-instructors.default">
        <div class="elementor-widget-container">
            <!-- Start Teacher -->
                            ...
                            @foreach ($teachers as $item)
                                <div class="teacher_item">
                                    <div class="teacher_image">
                                        <img src="{{ asset('storage/' . $item->photo) }}" class="img-fluid w-100"
                                            style="height:250px; object-fit:cover;" alt="{{ $item->name }}">
                                    ...
                                    <div class="teacher_content">
                                        <h4>
                                            <a
                                                href="profile/edplus/indexd527.html?view=instructor">{{ $item->name }}</a>
                                        </h4>
