...
@section('title', 'IJOMAC - Listar Cursos')
@section('content')
    <div class="nxl-content">
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">Lista de Cursos</li>
                </ul>
            </div>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a class="avatar-text avatar-md"
                                                            href="{{ route('admin.course.show', ['course' => $item]) }}">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.course.edit', ['course' => $item]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.course.delete', ['course' => $item]) }}">
