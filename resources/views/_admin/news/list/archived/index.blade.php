...
@section('title', 'Assessorarte - Notícias Arquivadas')
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Notícias Arquivadas</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                    <li class="breadcrumb-item">Arquivadas</li>
                </ul>
            </div>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.news.view', ['news' => $news]) }}"
                                                        ...
                                                        <div class="avatar-image avatar-md">
                                                            @if ($news->image)
                                                                <a href="{{ url('img/news/' . $news->image) }}">
                                                                    <img src="{{ url('img/news/' . $news->image) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="8" class="text-center text-muted py-4">
                                                    Não existem notícias arquivadas no momento.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
