...
@section('title', 'IJOMAC - Editar Galeria')
@section('content')
                        ...
                        <div class="card-body lead-status">
                            <div class="mb-5 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                                    <span class="d-block mb-2">Editando a Galeria :</span>
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Normalmente se refere a
                                        editar/atualizar uma nova Galeria</span>
                                </h5>
                            ...
                            <form action="{{ route('admin.galery.update', ['galery' => $galery->id]) }}"
                                ...
                                @method('PUT')
                                {{-- aqui o formulário --}}
                                @include('form._formGalery.index')
                                {{-- fim do formulário --}}
                            </form>
                        </div>
                    </div>
