...
@section('title', 'IJOMAC- Listar Galeria')
@section('content')
    <div class="nxl-content">
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">Lista de Galeria</li>
                </ul>
            </div>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a class="avatar-text avatar-md"
                                                            href="{{ route('admin.galery.show', ['galery' => $item]) }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.galery.edit', ['galery' => $item]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.galery.delete', ['galery' => $item]) }}">
