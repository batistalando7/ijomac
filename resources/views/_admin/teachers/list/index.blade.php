...
@section('title', 'ILOMAC - Listar Formadores')
@section('content')
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Formadores</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">Lista de Formadores</li>
                </ul>
            </div>
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('admin.teacher.create') }}" class="btn btn-danger">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a class="avatar-text avatar-md"
                                                            href="{{ route('admin.teacher.show', ['teacher' => $item]) }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.teacher.edit', ['teacher' => $item]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.teacher.delete', ['teacher' => $item]) }}">
