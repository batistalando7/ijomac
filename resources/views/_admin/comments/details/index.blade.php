                    ...
                    <div class="card card-body general-info">
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            <h5 class="fw-bold mb-0">
                                <span class="d-block mb-2">Informação detalhada :</span>
                                <span class="fs-12 fw-normal text-muted d-block">Informação detalhada do Comentário</span>
                            </h5>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $comment->subscription->email }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Notícia Relacionada</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
