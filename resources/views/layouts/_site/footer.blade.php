 <!-- Start Footer -->
 <footer class="footer-area fstyle-two"
     style="
                     ...
                     <div class="menu-company-container">
                         <ul id="menu-company" class="menu">
                             ...
                             <li id="menu-item-1174"
                                 ...
                                 <a href="#" onClick="return true">Instructor Details</a>
                             </li>
                     ...
                     <div class="textwidget">
                         ...
                         <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-1188" method="post" data-id="1188"
                             ...
                             <label style="display: none !important">Leave this field empty if you're human:
                                 ...
                                 value="1779957213" /><input type="hidden" name="_mc4wp_form_id"
                                 value="1188" /><input type="hidden" name="_mc4wp_form_element_id"
                                 value="mc4wp-form-1" />
